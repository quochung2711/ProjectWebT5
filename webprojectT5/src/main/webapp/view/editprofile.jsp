		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Profile Form Elements</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6">
								<form  action="saveprofile" method="post" name="editprofile" id="editprofile">
									<c:if test="${user != null}">
									...
									<div class="form-group">
										<label>First Name</label> <input class="form-control"
											...
											id="firstname" value="<c:out value='${user.firstname}' />">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="hidden" name="createdate"
											value="<c:out value='${user.createdate}' />" />
									</div>
									<div class="form-group">
										<input type="hidden" name="updatedate"
											value="<c:out value='${user.updatetime}' />" />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Phone</label> <input class="form-control"
											placeholder="Enter your phone number" name="phone" id="phone" value="<c:out value='${user.phone}' />">
									</div>
									<div class="form-group">
										<label>Description</label>
										<textarea class="form-control" rows="3" name="description"
											id="description" value="<c:out value='${user.description}' />"><c:out value='${user.description}' /></textarea>
									</div>
...
<script
	src="<c:url value ="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js"/>"></script>
<script
	src="<c:url value ="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js"/>"
