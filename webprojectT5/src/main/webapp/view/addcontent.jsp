			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6">
								<form name="addcontent" id="addcontent"
									...
									<div class="form-group">
										...
										<textarea class="form-control" rows="3" name="brief"
											placeholder="Enter the brief" id="brief"></textarea>
									</div>
									<div class="form-group">
										<label>Content</label>
										<textarea class="form-control" rows="8"
											placeholder="Enter the content" name="content" id="content"></textarea>
									</div>
									<button type="submit" class="btn btn-default">Submit
										Button</button>
									<button type="reset" onClick="fun()" class="btn btn-default">Reset
										Button</button>
								</form>
							</div>
							<!-- /.col-lg-6 (nested) -->
